...
public class Maps1 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(-8.228881, 114.360303);
        googleMap.addMarker(new MarkerOptions().position(sydney)
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.resto))
                .title("Garage Shop banyuwangi")
                 .snippet("Gambiran, Kabupaten Banyuwangi, Jawa Timur 68486"));
        ...
        googleMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Maps1.this);
                builder.setTitle("Garage Shop banyuwangi")
                        .setIcon(R.drawable.resto)
                        .setMessage("Gambiran, Kabupaten Banyuwangi, Jawa Timur 68486")
                        .setCancelable(false)
