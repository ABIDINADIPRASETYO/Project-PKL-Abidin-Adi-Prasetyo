...
public class Maps7 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(-8.098902, 112.166795);
        googleMap.addMarker(new MarkerOptions().position(sydney)
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.resto))
                .title("Blitar Town Square")
                 .snippet("Jalan Merdeka No.47, Kepanjen Lor, Kepanjenkidul, Kepanjen Lor, Kepanjenkidul, Kota Blitar, Jawa Timur 66117"));
        ...
        googleMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Maps7.this);
                builder.setTitle("Blitar Town Square")
                        .setIcon(R.drawable.resto)
                        .setMessage("Jalan Merdeka No.47, Kepanjen Lor, Kepanjenkidul, Kepanjen Lor, Kepanjenkidul, Kota Blitar, Jawa Timur 66117")
                        .setCancelable(false)
