...
public class Maps8 extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(-8.130471, 112.1596);
        googleMap.addMarker(new MarkerOptions().position(sydney)
                .icon(BitmapDescriptorFactory.fromResource(R.drawable.resto))
                .title("MAMMAH PRODUCTION")
                .snippet("Jl. Ternate No.38, Klampok, Sananwetan, Kota Blitar, Jawa Timur 66136"));
        ...
        googleMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
            ...
            public void onInfoWindowClick(Marker marker) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Maps8.this);
                builder.setTitle("MAMMAH PRODUCTION")
                        .setIcon(R.drawable.resto)
                        .setMessage("Jl. Ternate No.38, Klampok, Sananwetan, Kota Blitar, Jawa Timur 66136")
                        .setCancelable(false)
