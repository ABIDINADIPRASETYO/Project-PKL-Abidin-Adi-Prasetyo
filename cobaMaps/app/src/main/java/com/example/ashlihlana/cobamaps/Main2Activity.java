...
public class Main2Activity extends AppCompatActivity implements LocationListener,
    ...
    public static final String TAG_NAMA = "nama_Reseller";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapter, View view, int position, long arg) {
                ...
                if (position==0){
                    Intent intent0 = new Intent(Main2Activity.this, Maps0.class);
                    startActivity(intent0);
                } else if (position==1){
                    Intent intent1 = new Intent(Main2Activity.this, Maps1.class);
                    startActivity(intent1);

                } else if (position==2){
                    Intent intent2 = new Intent(Main2Activity.this, Maps2.class);
                    startActivity(intent2);

                }else if (position==3){
                    Intent intent3 = new Intent(Main2Activity.this, Maps3.class);
                    startActivity(intent3);

                }else if (position==4){
                    Intent intent4 = new Intent(Main2Activity.this, Maps4.class);
                    startActivity(intent4);

                }else if (position==5){
                    Intent intent5 = new Intent(Main2Activity.this, Maps5.class);
                    startActivity(intent5);

                }else if (position==6){
                    Intent intent6 = new Intent(Main2Activity.this, Maps6.class);
                    startActivity(intent6);

                }else if (position==7){
                    Intent intent7 = new Intent(Main2Activity.this, Maps7.class);
                    startActivity(intent7);

                }else if (position==8){
                    Intent intent8 = new Intent(Main2Activity.this, Maps8.class);
                    startActivity(intent8);

                }else if (position==9){
                    Intent intent9 = new Intent(Main2Activity.this, Maps9.class);
                    startActivity(intent9);

                }else if (position==10){
                    Intent intent10 = new Intent(Main2Activity.this, Maps10.class);
                    startActivity(intent10);

                }else if (position==11){
                    Intent intent11 = new Intent(Main2Activity.this, Maps11.class);
        ...
        adapter1 = new Adapter(this, itemList);
            ...
            public void onResponse(JSONArray response){
                ...
                for(int i = 0;i < response.length();i++) {
                    try {
                       ...
                       // j.setGambar(obj.getString(TAG_NAMA));
